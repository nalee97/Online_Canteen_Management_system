...
namespace Online_Canteen_Management_system.AllUserControls
{
    public partial class UC_UpdateItems : UserControl
    {
        ...
        {
            id = int.Parse(nalee2DataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString());
            String category = nalee2DataGridView1.Rows[e.RowIndex].Cells[2].Value.ToString();
            String name = nalee2DataGridView1.Rows[e.RowIndex].Cells[1].Value.ToString();
            int price = int.Parse(nalee2DataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString());
